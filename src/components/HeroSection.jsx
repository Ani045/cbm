            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                {[
                  ...
                  <motion.div
                    key={index}
                    className="flex items-center text-white bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-3"
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#3E1E76] focus:border-transparent outline-none transition-colors"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#3E1E76] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#9A070C] transition-colors duration-300 flex items-center justify-center group"
                >
